...
import com.chars.im.server.packets.*;
import com.chars.im.server.utils.JsonKit;
import com.chars.im.server.command.AbstractCmdHandler;
import com.chars.im.server.command.handler.userInfo.IUserInfo;
import com.chars.im.server.command.handler.userInfo.NonPersistentUserInfo;
import com.chars.im.server.command.handler.userInfo.PersistentUserInfo;
