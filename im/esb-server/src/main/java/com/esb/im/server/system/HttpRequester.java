...
public class HttpRequester {
     ...
     * @throws IOException
     */
    public String uploadFileSendPost(String urlString, MultipartFile files[])
            throws IOException {
        return this.uploadFileSendPost(urlString, "POST", files, null);
    }
     ...
     * @throws IOException
     */
    private String uploadFileSendPost(String urlString, String method,MultipartFile files[], Map<String, String> propertys)
            throws IOException {
