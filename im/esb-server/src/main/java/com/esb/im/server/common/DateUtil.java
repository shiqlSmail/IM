package com.esb.im.server.common;
...
public class DateUtil {
    ...
    public static final SimpleDateFormat YYYYMMDDHHMMSS_8 = new SimpleDateFormat("yyyyMMdd");
    public static final SimpleDateFormat YYYYMMDDHHMMSS_6 = new SimpleDateFormat("HHmmss");
