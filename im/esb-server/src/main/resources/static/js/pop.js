...
function showAjaxLoading(eventObj, mesg, _top, _left)
{
	...
	var modalHtmlStr = "";
	modalHtmlStr += "<img src=\"resource/img/loading2.gif\" style=\"margin-bottom: 3px;\" /><br />";
...
/*
	...
	modalSumitStr += "  <span style=\"color: #666; margin-left: auto; margin-right: auto; font-size:14px;margin-top:20px; padding-top:20px;\" class=\"initProLoading\"><img src=\"resources/img/loading2.gif\" style=\"margin-bottom:5px;margin-top:20px;\" /></br>"
...
//	tp=100;
	...
	modalHtmlStr += "<div class=\"loading_k\"><img src=\"resource/img/loading_img.gif\"/>&nbsp;&nbsp;" + msg + "</div>";
	modalHtmlStr += "                </div>";
	modalHtmlStr += "            </div>";
	modalHtmlStr += " </div>";
