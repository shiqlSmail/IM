...
/**
 * @description:SM2公钥加密算法实现 包括 -签名,验签 -密钥交换 -公钥加密,私钥解密
 * @author: shiqilong / jackSmail
 * @create: 2020-02-04 10:02
 */
public class SM2 {
	...
	public static String printHexString(byte[] b) {
		...
		for (int i = 0; i < b.length; i++) {
			...
			sm2HexStr = sm2HexStr + hex.toUpperCase();
		}
		return sm2HexStr;
	}
...
*/
		 ...
		 sm02.exportPublicKey(publicKey, "H:\\crypto\\esb-publickey.pem");
		 sm02.exportPrivateKey(privateKey, "H:\\crypto\\esb-privatekey.pem");
		...
		byte[] data = sm02.encrypt("helloWorld", publicKey);
		System.out.print("密文:");
		...
		System.out.println("解密后明文========:" + publicKey.getEncoded());
		System.out.println("解密后明文:===========" + publicKey.getEncoded());*/
	}
